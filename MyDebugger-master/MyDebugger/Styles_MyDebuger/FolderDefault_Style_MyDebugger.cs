...
namespace MyDebugger.Styles {
    public class FolderDefault_Style : Styles_MyDebugger {
        ...
        public override Rect Print(LogElement folderPayload) {
            ...
            Rect rect = EditorGUILayout.GetControlRect(true, folderStyle.fixedHeight, folderStyle);
            folderStyle.fontSize = 16;
            folderStyle.margin = new RectOffset((int)MyDebugWindow.ContentOffset.x / 2, 0, 5, 5);
